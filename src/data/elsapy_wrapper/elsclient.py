...
class ElsClient:
    ...
    # constructors
    def __init__(self, api_key, inst_token = None, num_res = 25, local_dir = None, accept="application/json"):
    ...
    @property
    def accept(self):
        """Gets the acceptable type of response"""
        return self._accept
